...
const rowHierarchy = {
    ...
    statusVisible: await firstRow.getByRole('button', { name: 'Tandai sold out' }).isVisible(),
...
const passed = [
    ...
    routeScrollReset,
    menuHierarchy.buttons.length === 1,
    menuHierarchy.previewCount === 0,
    menuHierarchy.addCount === 1,
    rowHierarchy.quickButtons === 2,
    rowHierarchy.statusVisible,
