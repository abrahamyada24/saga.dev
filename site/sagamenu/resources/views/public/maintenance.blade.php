...
<head>
    ...
    <style>
        :root { color-scheme:light; --ink:#171b18; --muted:#657068; --line:#d9dfda; --paper:#f3f5f1; --surface:#fff; --brand:#28665b; }
        * { box-sizing:border-box; }
        ...
        .status { display:grid; width:46px; height:46px; place-items:center; border-radius:8px; background:#e7f2ed; color:var(--brand); font-size:20px; font-weight:900; }
